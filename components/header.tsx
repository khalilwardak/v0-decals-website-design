...
export function Header() {
  ...
  return (
    <>
      ...
      {/* Mobile menu panel */}
      <div
        className={`lg:hidden fixed top-0 right-0 bottom-0 z-50 w-full max-w-sm bg-background shadow-xl transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="flex flex-col h-[calc(100%-73px)] px-4 py-6">
