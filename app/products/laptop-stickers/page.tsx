...
export default function LaptopStickersPage() {
  const products = getProductsByCategory("laptop-stickers")
  const info = categoryInfo["laptop-stickers"]

  const handleCustomRequest = () => {
    window.location.href = getMailtoLink("Custom Sticker Request")
  }
